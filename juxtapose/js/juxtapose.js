...
(function(document, window) {
    ...
    JXSlider.prototype = {
        ...
        displayCredits: function() {
            ...
            if (this.imgBefore.credit) { text += " <em>Enne</em> " + this.imgBefore.credit; }
            if (this.imgAfter.credit) { text += " <em>Pärast</em> " + this.imgAfter.credit; }
        ...
        _onLoaded: function() {
            ...
            if (this.imgBefore && this.imgBefore.loaded === true &&
                ...
                this.labCredit.setAttribute('hidden', true);
